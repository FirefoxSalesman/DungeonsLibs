...
import static net.firefoxsalesman.dungeonslibs.data.Codecs.ENCHANTMENT_DATA_CODEC;
import static net.firefoxsalesman.dungeonslibs.data.Codecs.ITEM_RARITY_CODEC;

public class BowGearConfig {

	public static final BowGearConfig DEFAULT = new BowGearConfig(new ArrayList<>(), new ArrayList<>(), 384, 20.0F,
			false, Rarity.COMMON);
