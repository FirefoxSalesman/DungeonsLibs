package net.firefoxsalesman.dungeonslibs.client.particles;
...
public class SnowflakeParticle extends TextureSheetParticle {
	...
	protected SnowflakeParticle(ClientLevel level, double xCoord, double yCoord, double zCoord, double xd,
			double yd, double zd) {
